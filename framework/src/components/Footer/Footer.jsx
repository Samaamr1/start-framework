      ...
      <div className="container mx-auto  py-7">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 py-10 gap-10 ">
          ...
          <div className="social p-4">
            ...
            <div className="icons flex justify-center items-center flex-wrap gap-4">
              <div className="size-8 border rounded-full flex justify-center items-center cursor-pointer duration-500 hover:text-mainColor p-2">
